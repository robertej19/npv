...
fig.data[170].visible = True
fig.data[171].visible = True
fig.data[172].visible = True
fig.data[173].visible = True
fig.data[174].visible = True
fig.data[175].visible = True
...
fig.add_annotation(
        ...
        #xref="x",
        #yref="y",
        text="Prevalence: {: 2.0f}%".format(set_Prevalence*100),
        #showarrow=True,
        font=dict(
            family="Courier New, monospace",
            size=14,
...
fig.write_html("htmls/{}_Line.html".format(file_type))
