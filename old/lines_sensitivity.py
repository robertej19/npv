...
for speci100 in np.arange(0, 100, 1):


    speci = set_Specificity
    sense = speci100/100
    sick = set_Prevalance*100
    scaler = 2
    healthy = 100 - sick
...
fig.add_annotation(
        ...
        #xref="x",
        #yref="y",
        text="Prevalance: {: 2.0f}%".format(set_Prevalance*100),
        #showarrow=True,
        font=dict(
            family="Courier New, monospace",
            size=14,
...
fig.write_html("{}_Line.html".format(file_type))
